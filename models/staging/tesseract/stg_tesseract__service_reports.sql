...
final AS (
    SELECT
        ...
        DATE_TRUNC('day', sr.fsr_complete_date) as complete_date,
        sr.fsr_cost_centre as cost_center,
        DATE_TRUNC('day', sr.fsr_complete_date) as dispatch_date,
        ...
        DATE_TRUNC('day', sr.fsr_complete_date) as start_date,
